...
export async function generateMetadata({ params }: Props) {
  ...
  return {
    ...
    icons: [
      { rel: "icon", url: project?.meta?.favicon ?? Favicon.src, sizes: "any", type: "image/png" },
      { rel: "icon", url: project?.meta?.favicon ?? Favicon32.src, sizes: "32x32", type: "image/png" },
      { rel: "icon", url: project?.meta?.favicon ?? Favicon16.src, sizes: "16x16", type: "image/png" },
      { rel: "apple-touch-icon", url: project?.meta?.favicon ?? AppleTouchIcon.src, sizes: "180x180" },
